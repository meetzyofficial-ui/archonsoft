  ...
  return (
    <div
      ...
      className={cn(
        ...
        "entrance-panel pointer-events-none fixed inset-0 z-[98] bg-[var(--color-ink)]",
    ...
    >
      ...
      >
        <span className="mono-label flex items-center gap-2.5 text-[var(--color-paper)]">
          <ArchonIcon id="archon-keystone-entrance" className="h-3.5 w-3.5" />
          Archon Soft
        </span>
        <span className="mono-label self-end text-[var(--fg-mute)]">
          Ankara
        </span>
      </div>
    </div>
